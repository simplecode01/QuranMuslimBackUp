        ...
        adapter.moreCLickListener={quran, totalAyah, position->
            ...
            btnPlayAyah.setOnClickListener {
                ...
                when(SaveSharedPreferences(requireContext()).ganti_qori){
                    0 ->{
                        imamArtist = "Syeikh Abdurrahman As-Sudais"
                    ...
                    2 ->{
                        imamArtist = "Sheikh Abu Bakr Al Shatri"
                    ...
                    3 ->{
                        imamArtist = "Ahmad bin Ali Al-Ajmi"
                    ...
                    4 ->{
                        imamArtist = "Shaykh Mishari Alafasy"
            ...
            btnPlaySurah.setOnClickListener {
                ...
                for (i in 1..totalAyah) {
                    ...
                    when(SaveSharedPreferences(requireContext()).ganti_qori) {
                        0 -> {
                            artistImam = "Syeikh Abdurrahman As-Sudais"
                        ...
                        2 -> {
                            artistImam = "Sheikh Abu Bakr Al Shatri"
                        ...
                        4 -> {
                            artistImam = "Shaykh Mishari Alafasy"
            ...
            btnLastRead.setOnClickListener {
                ...
                lifecycleScope.launch {
                    ...
                    Toast.makeText(requireContext(), "Save last read in Qs. ${quran.surahName}[${quran.surahNumber}]: ${quran.ayahNumber}", Toast.LENGTH_SHORT).show();
                }
                dialog.dismiss()
            }
